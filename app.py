...
# --- CSS HAUT CONTRASTE & INVERSION PARFAITE DU TEXTE ---
st.markdown("""
    <style>
    ...
    /* TEXTES SUR FOND SOMBRE : TOUJOURS BLANC PUR OU CYAN */
    ...
    /* INVERSION ABSOLUE : FOND BLANC + TEXTE NOIR PROFOND (#0F172A) */
    input, textarea, 
    .stTextInput input, 
    .stDateInput input, 
    .stNumberInput input,
...
# TITRE DE L'ONGLET MIS À JOUR DE FAÇON COMPACTE
