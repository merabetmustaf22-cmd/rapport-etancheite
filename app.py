    ...
    with st.form("form_mobile_chantier", clear_on_submit=True):
        ...
        if submitted:
            if not photos_galerie:
                ...
                # Création de l'arborescence : photos_chantier/Chantier/Date/
                ...
                for idx, p in enumerate(photos_galerie):
                    ...
                    # Chemin relatif : Chantier/Date/Fichier
                ...
                if fichiers_total:
                    ...
                    with zipfile.ZipFile(zip_buf, "w", zipfile.ZIP_DEFLATED) as zf:
                        for f_abs in fichiers_total:
                            # Conserve l'arborescence : Chantier/Date/Photo.jpg
            ...
            for _, row in df_show.iloc[::-1].iterrows():
                ...
                with st.container():
                    ...
                    for ph in raw_photos:
                        ph_clean = ph.strip()
                        # Recherche avec chemin complet Chantier/Date ou racine
...
with tab_admin:
    ...
    if pin == ADMIN_PIN:
        ...
        st.error("❌ Code secret incorrect.")t streamlit as st
import pandas as pd
from datetime import date
import os
import json
