...
import pandas as pd
from datetimeimport streamlit as st
import pandas as pd
...
st.markdown("""
    ...
    /* Main Dark Executive Header Banner */
    .header-cadre {
    ...
    /* Intervention Card in Dark Mode */
    .card-intervention {
...
# -------------------------------------------------------------
# ONGLET 2 : ESPACE CADRE & DIRECTION DARK
# -------------------------------------------------------------
with tab_admin:
    st.markdown("""
        <div class='header-cadre'>
    ...
    if pin == ADMIN_PIN:
        ...
        st.error("❌ Code d'accès non autorisé.") import date
import os
import json
import io
import zipfile
